        ...
        <div className=" bg-white w-full md:w-1/2 mt-10 flex flex-col gap-3">
          <div className="flex justify-between p-3">
            ...
            <div className=" flex gap-3">
             <button className=" border-2 border-black flex items-center gap-2 rounded-xl p-2"
              onClick={() => {
                let inp = document.getElementById("inp");
                inp.click();
              }}>  Choose
            <img width="20" height="20" src="https://img.icons8.com/ios-filled/30/video.png" alt="video"/>
            </button>
            <button
          ...
          <div className=" relative w-full  border-2 bg-white grid place-items-center">
             <video className=" w-full h-96 border-1" id="video-tag" autoPlay={true}>
